...
public class SearchResultAdapter extends RecyclerView.Adapter<SearchResultAdapter.SearchItemViewHolder> {
    ...
    class SearchItemViewHolder extends RecyclerView.ViewHolder {
        ...
        SearchItemViewHolder(View itemView) {
            super(itemView);
            leftIcon = (ImageView) itemView.findViewById(R.id.suggestions_item_icon);
            titleView = (TextView) itemView.findViewById(R.id.suggestions_item_title);
            subtitleView = (TextView) itemView.findViewById(R.id.suggestions_item_subtitle);
            floorView = (TextView) itemView.findViewById(R.id.suggestions_item_floor);

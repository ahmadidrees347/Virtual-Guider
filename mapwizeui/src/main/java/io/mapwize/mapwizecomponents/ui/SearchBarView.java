...
public class SearchBarView extends ConstraintLayout implements MapwizePlugin.OnVenueEnterListener,
    ...
    private void initialize(Context context) {
        ...
        mainLayout = (ConstraintLayout) findViewById(R.id.mapwizeSearchMainLayout);
        backImageView= (ImageView) findViewById(R.id.mapwizeSearchBarBackButton);
        leftImageView = (ImageView) findViewById(R.id.mapwizeSearchBarLeftButton);
        ...
        resultProgressBar = (ProgressBar) findViewById(R.id.mapwizeResultListProgress);
        rightImageView = (FrameLayout) findViewById(R.id.mapwizeSearchBarRightFrame);
        rightImageView.setOnClickListener(v -> {
            if (listener != null) {
                listener.onRightButtonClick(v);
            }
        });
        searchEditText = (EditText) findViewById(R.id.mapwizeSearchBarEditText);

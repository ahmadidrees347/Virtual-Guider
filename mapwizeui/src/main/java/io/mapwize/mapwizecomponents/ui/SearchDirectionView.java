...
public class SearchDirectionView extends ConstraintLayout implements
    ...
    private void initialize(Context context) {
        ...
        mapwizeDirectionMainLayout = (ConstraintLayout) findViewById(R.id.mapwizeDirectionMainLayout);
        fromEditText = (EditText) findViewById(R.id.mapwizeDirectionFromEditText);
        toEditText = (EditText) findViewById(R.id.mapwizeDirectionToEditText);
        resultProgressBar = (ProgressBar) findViewById(R.id.mapwizeDirectionProgressBar);
        backButton = (ImageView) findViewById(R.id.mapwizeDirectionBarBackButton);
        accessibilityOffButton = (ImageView) findViewById(R.id.mapwizeDirectionAccessibilityOffButton);
        accessibilityOffButton.setOnClickListener(v -> setAccessibility(false));
        accessibilityOnButton = (ImageView) findViewById(R.id.mapwizeDirectionAccessibilityOnButton);
        accessibilityOnButton.setOnClickListener(v -> setAccessibility(true));
        swapButton = (ImageView) findViewById(R.id.mapwizeDirectionBarSwapButton);

...
public class MapwizeFragment extends Fragment implements CompassView.OnCompassClickListener,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Mapbox.getInstance(getContext(), "ZTdhZ7Ui4uBAhYFr");
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        FrameLayout layout = (FrameLayout) view.findViewById(R.id.mapViewContainer);
    ...
    private void loadViews(View view) {
        mainLayout = (ConstraintLayout) view.findViewById(R.id.mapwizeFragmentLayout);
        compassView = (CompassView) view.findViewById(R.id.mapwizeCompassView);
        followUserButton = (FollowUserButton) view.findViewById(R.id.mapwizeFollowUserButton);
        floorControllerView = (FloorControllerView) view.findViewById(R.id.mapwizeFloorController);
        searchBarView = (SearchBarView) view.findViewById(R.id.mapwizeSearchBar);
        searchDirectionView = (SearchDirectionView) view.findViewById(R.id.mapwizeDirectionSearchBar);
        universesButton = (UniversesButton) view.findViewById(R.id.mapwizeUniversesButton);
        languagesButton = (LanguagesButton) view.findViewById(R.id.mapwizeLanguagessButton);
        bottomCardView = (BottomCardView) view.findViewById(R.id.mapwizeBottomCardView);
        searchResultList = (SearchResultList) view.findViewById(R.id.mapwizeSearchResultList);
    }
